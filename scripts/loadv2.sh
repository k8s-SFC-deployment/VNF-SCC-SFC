...
FIRST_REQUEST_PARAM_NEXT=$(urlencode '{"target_url": "http://localhost:7000/load","message": {"processingLoad": {"cpu": {"ops": 5000,"worker": 1,"limit": 50},"mem": {"ops": 5000,"worker": 1,"bytes": 10000},"dio": {"ops": 5000,"worker": 1,"bytes": 10000000}},"transmittingLoad": null,"next": {"target_url": "http://localhost:7000/loadv2","message": null}}}')
